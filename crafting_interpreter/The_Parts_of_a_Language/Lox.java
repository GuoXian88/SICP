...
public class Lox {
  ...
  /*
   * 分离出错的代码和报错的代码  TODO: eally, we would have an actual abstraction, some k
   *  nd of “ErrorReporter” interface that gets passed to the scanner and  rser
   * o that we can swap out different reporting strategies.
   * 
   */
